...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* panel */}
      <aside
        className={`fixed top-1/2 -translate-y-1/2 left-0 z-50 h-[844px] w-[340px] rounded-r-2xl shadow-2xl backdrop-blur-md
      ...
      >
        <div className="px-7 pt-10 pb-4 border-b border-white/40 flex items-center justify-between">
          ...
          <Button variant="ghost" size="icon" onClick={close} className="text-white/90">
            <X className="w-6 h-6" />
          </Button>
        </div>
        ...
        <nav className="px-7 space-y-6 mt-6">
          <div className="flex items-center justify-between">
            <button className="flex items-center space-x-3 text-white/95" onClick={() => go("/voice-chat")}> 
          ...
          <div className="flex items-center justify-between">
            <button className="flex items-center space-x-3 text-white/95" onClick={() => go("/my-page")}> 
          ...
          <div className="flex items-center justify-between">
            <button className="flex items-center space-x-3 text-white/95" onClick={() => go("/start-page")}> 
