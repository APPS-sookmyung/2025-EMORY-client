        ...
        <div className="flex flex-col items-center px-6 pt-16">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mb-4 shadow-lg border border-white/30">
              <User className="w-12 h-12 text-gray-400" /> {/* ✅ 수정됨: 흰색 아이콘으로 변경 */}
            </div>
            <h1 className="text-2xl font-medium text-gray-400 mb-1 drop-shadow-sm">Jeewon</h1> {/* ✅ 수정됨: 흰색 텍스트 */}
            <p className="text-gray-400 text-sm mb-6 drop-shadow-sm">emory@gmail.com</p> {/* ✅ 수정됨 */}
          ...
          <div className="w-full px-6 space-y-3 mt-8 pb-10"> {/* ✅ 수정됨: 전체 폭 사용 */}
            ...
            >
              <span className="text-gray-400 font-medium">캘린더</span> {/* ✅ 수정됨 */}
